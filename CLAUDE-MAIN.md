...
- `firmware/shared_inc/` - Shared headers used by multiple chips (serial protocols, ring buffers)
...
- **STM32 (mgmt, ui)**: arm-none-eabi-gcc, make, python3 with pyserial
- **ESP32 (net)**: ESP-IDF v5.4.2, make
- **Flashing**: st-flash, STM32_Programmer_CLI, or openocd (optional alternatives)
