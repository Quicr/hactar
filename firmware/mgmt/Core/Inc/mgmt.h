...
extern "C" {
    ...
    #define USB_PORT USB_TX1_MGMT_GPIO_Port
    // The input data register bit on mgmt
    #define USB_RX_Bit (uint32_t)USB_TX1_MGMT_Pin
    // The output data register bit on mgmt
    #define USB_TX_Bit_On (uint32_t)USB_RX1_MGMT_Pin
    #define USB_TX_Bit_Off ~USB_TX_Bit_On

    #define UI_PORT UI_TX1_MGMT_GPIO_Port
    // The input data register bit on mgmt
    #define UI_RX_Bit (uint32_t)UI_TX1_MGMT_Pin
    // The output data register bit on mgmt
    #define UI_TX_Bit_On (uint32_t)UI_RX1_MGMT_Pin
    #define UI_TX_Bit_Off ~UI_TX_Bit_On

    #define NET_PORT NET_TX1_MGMT_GPIO_Port
    // The input data register bit on mgmt
    #define NET_RX_Bit (uint32_t)NET_TX1_MGMT_Pin
    // The output data register bit on mgmt
    #define NET_TX_Bit_On (uint32_t)NET_RX1_MGMT_Pin
    #define NET_TX_Bit_Off ~NET_TX_Bit_On
