...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LEDA_B_Pin|UI_BOOT_Pin|NET_RST_Pin|NET_BOOT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RTS_Pin CTS_Pin LEDB_G_Pin LEDB_B_Pin */
  GPIO_InitStruct.Pin = RTS_Pin|CTS_Pin|LEDB_G_Pin|LEDB_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : UI_STAT_Pin NET_STAT_Pin */
  GPIO_InitStruct.Pin = UI_STAT_Pin|NET_STAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
