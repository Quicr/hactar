...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOB,
                      LEDB_R_Pin | LEDB_G_Pin | LEDB_B_Pin | UI_NRST_Pin | NET_NRST_Pin
                          | NET_BOOT_Pin | UI_BOOT1_Pin,
                      GPIO_PIN_RESET);
    ...
    GPIO_InitStruct.Pin = LEDB_R_Pin | LEDB_G_Pin | LEDB_B_Pin | UI_NRST_Pin | NET_NRST_Pin
                        | NET_BOOT_Pin | UI_BOOT1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
