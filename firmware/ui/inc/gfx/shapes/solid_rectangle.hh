...
public:
    ...
    static void Draw(GraphicMemory& memory,
                     ...
                     Colour colour)
    {
        std::span<uint8_t> buff = memory.AllocateMemory(sizeof(SolidRectangle));
    ...
    static bool Render(SolidRectangle* rectangle,
                       uint8_t* matrix,
...
private:
    ...
    Polygon::Type polygon_type = Polygon::Type::SolidRectangle;
    uint16_t x;
    uint16_t y;
    uint16_t width;
    uint16_t height;
...
static_assert(sizeof(SolidRectangle) == 11U);