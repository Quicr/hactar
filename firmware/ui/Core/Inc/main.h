...
/* Private defines -----------------------------------------------------------*/
#define KB_ROW5_Pin GPIO_PIN_13
#define KB_ROW5_GPIO_Port GPIOC
#define KB_ROW6_Pin GPIO_PIN_14
#define KB_ROW6_GPIO_Port GPIOC
#define KB_COL5_Pin GPIO_PIN_15
...
#define KB_ROW1_Pin GPIO_PIN_4
#define KB_ROW1_GPIO_Port GPIOC
#define KB_ROW2_Pin GPIO_PIN_5
#define KB_ROW2_GPIO_Port GPIOC
#define PLUG_DETECT_Pin GPIO_PIN_1
#define PLUG_DETECT_GPIO_Port GPIOB
