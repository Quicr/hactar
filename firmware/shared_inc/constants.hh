...
static constexpr SampleRates Sample_Rate = SampleRates::_16khz;
...
static constexpr uint16_t Total_Audio_Buffer_Sz = Num_Buffers * (uint16_t)Sample_Rate * 2 * Audio_Time_Length_s;
